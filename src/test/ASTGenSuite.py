...
class ASTGenSuite(unittest.TestCase):
    def test_declared(self):
        ...
        input = """
            number VoTien
        """
        expect = str(Program([VarDecl(Id("VoTien"), NumberType())]))
        ...
        """
        expect = str(
            Program([VarDecl(Id("VoTien"), StringType(), None, NumberLiteral(1.0))])
        )
        # print(expect)
        ...
        expect = str(
            Program(
                [
                    VarDecl(
                        Id("VoTien"),
                        ArrayType([5.0, 3.0, 4.2], NumberType()),
                        None,
                        NumberLiteral(1.0),
                    ),
        ...
        input = """
            var Votien <- 1
        """
        expect = str(Program([VarDecl(Id("Votien"), None, "var", NumberLiteral(1.0))]))
        # print(expect)
                ...
                [
                    ...
                    FuncDecl(
                        ...
                        [
                            ...
                            VarDecl(Id("a"), ArrayType([2.0], BoolType())),
                        ],
                        None,
                    ),
                    FuncDecl(
                        Id("main"),
                        [VarDecl(Id("Votien"), ArrayType([1.0, 2.0], NumberType()))],
                        Return(None),
                    ),
                ]
            )
    ...
    def test_Expression(self):
            ...
            Program(
                [
                    ...
                    VarDecl(
                        ...
                        None,
                        "var",
                        ArrayLiteral([ArrayLiteral([NumberLiteral(1.0)])]),
                    ),
                ]
            )
        )
            ...
            Program(
                [
                    VarDecl(
                        ...
                        None,
                        "var",
                        BinaryOp("...", NumberLiteral(1.0), StringLiteral("2")),
                    ),
                    VarDecl(
                        Id("x"),
                        None,
                    ...
                    VarDecl(
                        ...
                        BinaryOp(
                            "or",
                            BinaryOp("and", NumberLiteral(1.0), NumberLiteral(2.0)),
                            NumberLiteral(3.0),
                        ),
                    ),
                    VarDecl(
                    ...
                    VarDecl(
                        ...
                        None,
                        "var",
                        UnaryOp("-", UnaryOp("-", UnaryOp("-", NumberLiteral(1.0)))),
                    ),
                    VarDecl(
                        Id("x"),
                        None,
                        "var",
                        UnaryOp("not", UnaryOp("not", NumberLiteral(1.0))),
                    ),
                        ...
                        BinaryOp(
                            ...
                            BinaryOp(
                                ...
                                BinaryOp(
                                    "and",
                                    BinaryOp(
                                        "or", NumberLiteral(2.0), NumberLiteral(3.0)
                                    ),
                                    NumberLiteral(1.0),
                                ),
                                NumberLiteral(2.0),
                            ...
                            BinaryOp(
                                ...
                                BinaryOp(
                                    ...
                                    UnaryOp("not", UnaryOp("-", NumberLiteral(2.0))),
                                ),
                            ),
                        ),
                    )
        ...
        input = """
            var x <- fun()
        """
        expect = str(Program([VarDecl(Id("x"), None, "var", CallExpr(Id("fun"), []))]))
        # print(expect)
            ...
            Program(
                [
                    VarDecl(
                        ...
                        None,
                        "var",
                        CallExpr(Id("fun"), [CallExpr(Id("fun"), [])]),
                    )
                ]
            )
        )
            ...
            Program(
                [
                    VarDecl(
                        ...
                        BinaryOp(
                            "...",
                            BinaryOp("...", NumberLiteral(2.0), NumberLiteral(3.0)),
                            NumberLiteral(4.0),
                        ),
                    )
                ]
                    ...
                    FuncDecl(
                        ...
                        Block(
                            [
                                Return(
                                    BinaryOp(
                                        "+", NumberLiteral(1.0), NumberLiteral(1.0)
                                    )
                                ),
                                Return(),
                            ]
                    ...
                    FuncDecl(
                        ...
                        Block(
                            [
                                ...
                                CallStmt(
                                    Id("main"), [NumberLiteral(1.0), NumberLiteral(1.0)]
                                ),
                            ]
                        ),
                    ),
                    FuncDecl(Id("main"), [], Block([CallStmt(Id("main"), [])])),
                ]
            )
        )
        # print(expect)
                    ...
                    FuncDecl(
                        ...
                        Block(
                            [
                                ...
                                Assign(
                                    ArrayCell(Id("a"), [NumberLiteral(1.0)]),
                                    NumberLiteral(2.0),
                                ),
                                Assign(
                                    ArrayCell(
                                    ...
                                    BinaryOp(
                                        "+", NumberLiteral(4.0), NumberLiteral(2.0)
                                    ),
                                ),
                            ]
                        ),
            ...
            Program(
                [
                    ...
                    VarDecl(
                        ...
                        ArrayCell(
                            CallExpr(
                                Id("fun"), [NumberLiteral(1.0), NumberLiteral(2.0)]
                            ),
                            [NumberLiteral(1.0), NumberLiteral(3.0)],
                        ),
                    ),
                ]
            )
                    ...
                    FuncDecl(
                        ...
                        Block(
                            [
                                ...
                                VarDecl(
                                    Id("c"),
                                    ArrayType([200.0, 2.0], NumberType()),
                                    None,
                                    NumberLiteral(3.6),
                                ),
                                VarDecl(
                                    Id("c"), ArrayType([3.823], StringType()), None
                                ),
                            ]
                        ),
                    )
